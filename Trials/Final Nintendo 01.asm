...
;Author Data
author_page_line_1  db 10,13, '                   **************************************************$'
author_page_line_2  db 10,13, '                   **               Submitted By:                  **$'
author_page_line_3  db 10,13, '                   **                 Group: 12                    **$'
author_page_line_4  db 10,13, '                   **                                              **$'
author_page_line_5  db 10,13, '                   **               Tahmid Iqbal                   **$'
author_page_line_6  db 10,13, '                   **                 21201701                     **$'
author_page_line_7  db 10,13, '                   **                                              **$'
author_page_line_8  db 10,13, '                   **              Rizwanul Islam                  **$'
author_page_line_9  db 10,13, '                   **                 21201129                     **$'
author_page_line_10 db 10,13, '                   **                                              **$'
author_page_line_11 db 10,13, '                   **  Department of Computer Science Engineering  **$' 
author_page_line_12 db 10,13, '                   **                                              **$'
author_page_line_13 db 10,13, '                   **             BRAC University                  **$'
author_page_line_14 db 10,13, '                   **                                              **$'
author_page_line_15 db 10,13, '                   **                 CSE341                       **$'
author_page_line_16 db 10,13, '                   **             Microprocessor                   **$'
author_page_line_17 db 10,13, '                   **                                              **$'
author_page_line_18 db 10,13, '                   **                Fall 2024                     **$'
author_page_line_19 db 10,13, '                   **                                              **$'
author_page_line_20 db 10,13, '                   **************************************************$'                   
...
exit_game:
    ...
    mov ah, 09
    int 21h
    lea dx, author_page_line_14
    mov ah, 09
    int 21h
    lea dx, author_page_line_15
    mov ah, 09
    int 21h
    lea dx, author_page_line_16
    mov ah, 09
    int 21h
    lea dx, author_page_line_17
    mov ah, 09
    int 21h
    lea dx, author_page_line_18
    mov ah, 09
    int 21h
    lea dx, author_page_line_19
    mov ah, 09
    int 21h
    lea dx, author_page_line_20
    mov ah, 09
    int 21h
