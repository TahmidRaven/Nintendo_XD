...
;Author Data
sumitted_by    db 10,13, 'Submitted By:$'
author_1       db 10,13, 'Tahmid Iqbal$'
author_1_id    db 10,13, '21201701$'
author_2       db 10,13, 'Rizwanul Islam$'
author_2_id    db 10,13, '21201129$'
dep            db 10,13, 'Department: Computer Science and Engineering$'
session        db 10,13, 'Fall 2024$'
